...
Now the table. It is a rectangle of numbers: one row per token id, each row `d_model` wide. From [`lib/embedding.py`](https://github.com/QuantumindSSI/Technologues/blob/main/lib/embedding.py):
